...
let package = Package(
    ...
    dependencies: [
        ...
        .package(url: "https://github.com/nodes-vapor/forms.git", .upToNextMinor(from: "0.4.0")),
    ...
    targets: [
        .target(name: "JWTKeychain", dependencies: ["Punctual", "Flash", "Forms", "Sugar", "FluentProvider", "JWTProvider", "LeafProvider", "Vapor", "Validation"]),
